...
class ServicioContratoPolicy
{
    ...
    {
        return $user->can('view_any_servicio::contrato');
    }

    /**
     * Determine whether the user can view the model.
     */
    public function view(User $user, ServicioContrato $servicioContrato): bool
    {
        return $user->can('view_servicio::contrato');
    }
    ...
    {
        return $user->can('create_servicio::contrato');
    }

    /**
     * Determine whether the user can update the model.
     */
    public function update(User $user, ServicioContrato $servicioContrato): bool
    {
        return $user->can('update_servicio::contrato');
    }
